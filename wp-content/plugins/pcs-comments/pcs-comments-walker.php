 ...
 * @see Walker
 */
class PCS_Walker_Comment extends Walker {
	...
	public function end_el( &$output, $comment, $depth = 0, $args = array() ) {
		...
		if ( ! empty( $_GET['replytocom'] ) && $_GET['replytocom'] == $commentID ) {
			...
			$output .= sprintf( '<div style="padding-left:40px">%s</div>', ob_get_clean() );
		}
...
?>
		...
		<div class="comment-meta commentmetadata">
			...
			<?php
				...
				printf( __( '%1$s at %2$s' ), get_comment_date( '', $comment ),  get_comment_time() ); ?></a> <?php echo pcs_modify_edit_comment_link( '', $comment ); ?>
		</div>
