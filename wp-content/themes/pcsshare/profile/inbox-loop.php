...
<?php if ( bp_has_message_threads( 'box=inbox' ) ) : ?>
					...
					<tr id="m-<?php bp_message_thread_id(); ?>" class="<?php bp_message_css_class(); ?><?php if ( bp_message_thread_has_unread() ) : ?> unread<?php else: ?> read<?php endif; ?>">
						...
						<td class="thread-options">
							<?php if ( bp_message_thread_has_unread() ) : ?>
								<?php $url = str_replace( 'public', 'inbox', bp_get_the_message_thread_mark_read_url() ); ?>
								<a class="read" href="<?php echo $url;?>"><?php _e( 'Read', 'buddypress' ); ?></a>
							<?php else : ?>
								<?php $url = str_replace( 'public', 'inbox', bp_get_the_message_thread_mark_unread_url() ); ?>
								<a class="unread" href="<?php echo $url;?>"><?php _e( 'Unread', 'buddypress' ); ?></a>
							<?php endif; ?>
							 |
							<?php $url = str_replace( 'public', 'inbox', bp_get_message_thread_delete_link() ); ?>
							<a class="delete" href="<?php echo $url; ?>"><?php _e( 'Delete', 'buddypress' ); ?></a>
