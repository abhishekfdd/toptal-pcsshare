				...
				<div class="register-section" id="profile-details-section">
					...
					<?php while ( bp_profile_fields() ) : bp_the_profile_field(); ?>
						...
						<div<?php bp_field_css_class( 'editfield' ); ?>>
							...
							<?php
							// remove rich text editor from custom profile fields marked as textarea
//              add_filter( 'bp_xprofile_is_richtext_enabled_for_field', false, bp_get_the_profile_field_id() );
